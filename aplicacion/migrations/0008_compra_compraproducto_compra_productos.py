...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('aplicacion', '0007_remove_pedido_productos_remove_pedido_persona_and_more'),
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='compra',
            name='productos',
            field=models.ManyToManyField(through='aplicacion.CompraProducto', to='aplicacion.producto'),
        ),
    ]
